...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        @if (!$isConnected)
            <div
                class="flex items-center gap-2 px-4 py-2 bg-yellow-50 border border-yellow-200 rounded-xl text-sm text-yellow-700">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-6">
        ...
        <form method="POST" action="{{ route('drive.upload') }}" enctype="multipart/form-data" id="uploadForm">
            @csrf
