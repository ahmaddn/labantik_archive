    ...
    <div class="w-full max-w-md">
        ...
        <div class="rounded-2xl border border-gray-100 bg-white p-8 shadow-xl">
            ...
            <div class="mb-8 text-center">
                <div class="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-white shadow-lg overflow-hidden">
                    <img src="https://smkn1talaga.sch.id/assets/images/logosmk.png" alt="Portofolio Digital" class="h-full w-full object-contain p-1">
                </div>
