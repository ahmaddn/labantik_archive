        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                <div>
                    ...
                    <input type="text" name="main_title" id="input-main-title" value="{{ old('main_title', 'SERTIFIKAT') }}" required
                           class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:bg-white focus:ring-2 focus:ring-blue-500">
                </div>
                ...
                <div>
                    ...
                    <select name="word_art_font" id="select-word-art-font" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:bg-white focus:ring-2 focus:ring-blue-500">
                        <option value="cinzel" {{ old('word_art_font', 'cinzel') == 'cinzel' ? 'selected' : '' }}>Cinzel (Serif Classic / Default)</option>
                        <option value="great-vibes" {{ old('word_art_font') == 'great-vibes' ? 'selected' : '' }}>Great Vibes (Calligraphy / Cursive)</option>
                        <option value="dancing-script" {{ old('word_art_font') == 'dancing-script' ? 'selected' : '' }}>Dancing Script (Handwriting)</option>
                        <option value="alex-brush" {{ old('word_art_font') == 'alex-brush' ? 'selected' : '' }}>Alex Brush (Elegant Cursive)</option>
                        <option value="sacramento" {{ old('word_art_font') == 'sacramento' ? 'selected' : '' }}>Sacramento (Script)</option>
                        <option value="pacifico" {{ old('word_art_font') == 'pacifico' ? 'selected' : '' }}>Pacifico (Fun Bold Script)</option>
                        <option value="playfair" {{ old('word_art_font') == 'playfair' ? 'selected' : '' }}>Playfair Display (Luxury Serif)</option>
                        <option value="montserrat" {{ old('word_art_font') == 'montserrat' ? 'selected' : '' }}>Montserrat (Modern Bold Sans)</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="word_art_style" id="select-word-art-style" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:bg-white focus:ring-2 focus:ring-blue-500">
                        <option value="none" {{ old('word_art_style') == 'none' ? 'selected' : '' }}>Standar Flat Blue</option>
                        <option value="gold-gradient" {{ old('word_art_style', 'gold-gradient') == 'gold-gradient' ? 'selected' : '' }}>WordArt Gold Metallic (Emas Lux 3D)</option>
                        <option value="blue-royal" {{ old('word_art_style') == 'blue-royal' ? 'selected' : '' }}>WordArt Royal Gradient (Biru Kerajaan)</option>
                        <option value="emerald-lux" {{ old('word_art_style') == 'emerald-lux' ? 'selected' : '' }}>WordArt Emerald Emerald (Zamrud Metallic)</option>
                        <option value="ruby-crimson" {{ old('word_art_style') == 'ruby-crimson' ? 'selected' : '' }}>WordArt Ruby Crimson (Merah Delima)</option>
                        <option value="silver-metallic" {{ old('word_art_style') == 'silver-metallic' ? 'selected' : '' }}>WordArt Silver Chrome (Perak Metallic)</option>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                <div class="md:col-span-1">
                    ...
                    <textarea name="back_page_title" rows="2"
                              class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:bg-white focus:ring-2 focus:ring-blue-500">{{ old('back_page_title', 'STRUKTUR PROGRAM IHT PANCAWALUYA SMKN 1 TALAGA TAHUN ' . date('Y')) }}</textarea>
                </div>
