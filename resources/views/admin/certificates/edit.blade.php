            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                <div class="md:col-span-1">
                    ...
                    <textarea name="back_page_title" rows="2"
                              class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:bg-white focus:ring-2 focus:ring-blue-500">{{ old('back_page_title', $certificate->back_page_title) }}</textarea>
                </div>
