        ...
        <div class="page">
            ...
            <table class="info-table">
                ...
                <tr>
                    ...
                    <td class="sep">:</td>
                    <td style="font-weight:bold;">{{ strtoupper($item->student->full_name) }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="sep">:</td>
                    <td>{{ $item->letter ? \Carbon\Carbon::parse($item->letter->graduation_date)->translatedFormat('j F Y') : '-' }}
                    </td>
                </tr>
                <tr>
            ...
            <table class="nilai-table">
                ...
                <tbody>
                    ...
                    <tr class="rata-rata">
                        ...
                        <td class="col-na">{{ $item->rataRata }}</td>
                    </tr>
                </tbody>
            </table>
