...
<head>
    ...
    <title>Export Surat Pernyataan - Semua Siswa</title>
        ...
        <div class="page-pernyataan">
            ...
            <table class="pernyataan-info-table">
                <tr>
                    ...
                    <td class="sep">:</td>
                    <td>{{ strtoupper($item->student->full_name ?? '—') }}</td>
                </tr>
                <tr>
            ...
            <p class="pernyataan-text">Menyatakan secara sadar dan sungguh-sungguh apabila saya dinyatakan lulus tidak
                akan
                melakukan:</p>

            <ol class="pernyataan-ol">
                <li>Hal-hal yang tidak terpuji, seperti mencorat-coret baju atau sarana dan prasarana fasilitas umum.
                </li>
                <li>Konvoi kendaraan sehingga mengganggu pengguna jalan lainnya.</li>
                <li>Kumpul-kumpul pada tempat tertentu dengan melakukan hal yang tidak terpuji yang akan merusak nama
                    baik
            ...
            <p class="pernyataan-text">Demikian pernyataan saya dibuat dengan sadar tanpa paksaan dari pihak mana pun.
            </p>
            ...
            <div class="ttd-pernyataan">
                ...
                <div class="ttd-pernyataan-block">
                    ...
                    <div>NISN. {{ $item->student->national_student_number ?? '—' }}</div>
                </div>
            </div>
